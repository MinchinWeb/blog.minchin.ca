title: Advanced Python: Self-Configuring Themes, and Seafoam 2.6.0 Released
...
from `setuptools.find_packages()` to `setuptools.find_namespace_packages()`. I
also had to add the non-Python files to my `MANIFEST.in` file:
