...
ability to my <code markdown=1>minchin.&ZeroWidthSpace;pelican.&ZeroWidthSpace;plugins</code> namespace, and thus will autoload my
...
current <code markdown=1>minchin.&ZeroWidthSpace;pelican.&ZeroWidthSpace;plugins</code> namespace. With *AutoLoader*, it makes it
...
autoload any installed plugins in the <code markdown=1>minchin.&ZeroWidthSpace;pelican.&ZeroWidthSpace;plugins</code> namespace (and
